...
<div class="pagetitle fade-slide-up">
  <h1 class="fw-bold text-primary">Catégories</h1>
</div>
    ...
    <div class="col-md-4">
      <div class="card card-hover-lift">
        <div class="card-body d-flex justify-content-between align-items-start">
          ...
          <span class="badge badge-soft rounded-pill">Inventaire</span>
        </div>
      </div>
    </div>
    <div class="col-md-8 d-flex justify-content-end align-items-center">
      <button class="btn btn-gradient-primary" data-bs-toggle="modal" data-bs-target="#modalCreateCategorie">
      ...
      <table id="categoriesTable" class="table table-hover align-middle">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-end">
              <div class="btn-group">
                <a href="{{ route('categories.edit', $categorie->id) }}" class="btn btn-outline-primary btn-sm"><i class="bi bi-pencil"></i></a>
                <button class="btn btn-outline-danger btn-sm btn-delete" data-id="{{ $categorie->id }}"><i class="bi bi-trash"></i></button>
              </div>
            </td>
          </tr>
          @endforeach
...
<div class="modal fade" id="modalCreateCategorie" tabindex="-1" aria-hidden="true">
...
<script>
$(function() {
  $('#categoriesTable').DataTable({ pageLength: 10 });
  ...
  $('.btn-delete').on('click', function() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const form = $('<form>', { method: 'POST', action: '/categories/' + id })
          .append('@csrf')
